...
if (!window.Stripo.loaded) {
    ...
    if (!curScript) {
        ...
        // addResource('assets/js/browser-polyfill.min.js', 'scripts1', true);
        if (!window.jQuery) {
        ...
        !window.Zone && addResource('assets/imageeditor/zone.min.js', 'scripts4', true);
        addResource('assets/imageeditor/scripts.min.js', 'scripts4', true);
        addResource('main.f20413aaad89ef2b4015.js', 'scripts5', true);
