...
(function (window, document, exports, global, define, undefined) {
    ...
    if (window && window.ES6Promise && window.ES6Promise.polyfill) {
    ...
    function createWindowClone(ownerDocument, containerDocument, width, height, options, x, y) {
        ...
        //leave required element only
        let node = $(options.node).closest('.esd-block')[0].cloneNode(true);
        $(documentElement).find('body').html(``);
        $(documentElement).find('body').append(node);
        //leave required element only
    ...
    Renderer.prototype.renderImage = function (container, bounds, borderData, imageContainer) {
        ...
        imageContainer.originalContainer = container;
    ...
    function wannaGetHigh(width, height) {
        const MAX_WIDTH = 200;
    ...
    CanvasRenderer.prototype.drawImage = function (imageContainer, sx, sy, sw, sh, dx, dy, dw, dh) {
        if (!this.taints(imageContainer) || this.options.allowTaint) {
            this.ctx.filter = imageContainer.originalContainer.css('filter');
            this.ctx.imageSmoothingQuality = wannaGetHigh(dw, dh) ? 'high' : 'low';
...
}).call({}, typeof(window) !== "undefined" ? localWindow : undefined, typeof(document) !== "undefined" ? document : undefined);

window.stripoHtml2canvas = localWindow.html2canvas;