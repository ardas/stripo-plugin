...
(function($, undefined) {
    ...
    $.fn.split = function(options) {
        ...
        self.bind('splitter.resize', function(e) {
            //--------- GAA: patched undefined position start------------
            var pos = self.position() || 0;
            //--------- GAA: patched undefined position end ------------
        ...
        if (splitters.filter(Boolean).length === 0) {
            ...
            $(document.documentElement).on('mousedown.splitter touchstart.splitter', function(e) {
                if (splitter_id !== null) {
                    ...
                    setTimeout(function() {
                        current_splitter && $('<div class="splitterMask"></div>').
                ...
                if (current_splitter) {
                    ...
                    /*//--------- YS: wrong splitter top START ------------
                    if (current_splitter.settings.invisible) {
                        const hsplitter = current_splitter.find('.hsplitter')[0];
                        const top = hsplitter.offsetTop;
                        hsplitter.style.top = (top - 3) + 'px';
                    }
                    //--------- YS: wrong splitter top END ------------*/
