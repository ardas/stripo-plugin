...
if (!window.Stripo.loaded) {
    ...
    if (!curScript) {
        console.error('Can not find Stripo script tag. Please add id="stripoScript" to Stripo script tag');   // eslint-disable-line no-console
    } else {
        var bp = curScript.src.substring(0, curScript.src.indexOf('stripo.js'));
        ...
        addResource('stripodeps.4696266b723a37080ee2.js', 'scripts2', true);
        addResource('assets/imageeditor/scripts.min.js', 'scripts3', true);
        addResource('main.4696266b723a37080ee2.js', 'scripts4', true);
